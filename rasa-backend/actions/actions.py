...
class ActionPredictHeartDisease(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        try:
            ...
            model_path = r'C:/Users\Admin\PycharmProjects\chatlord/rasa-backend\models\heart_disease_model_logistic.pkl'
